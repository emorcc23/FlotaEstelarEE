		...
		<div class="form-actualizar" id="form-actualizar-nave-dos" class="container login-container">
			...
			<div class="row">
				<div class="col-md-6 login-form-1">
					...
					<form action='/FlotaEstelarEE/ServActTripulante' method="POST">
						<div class="form-group">
							<input type="text" class="form-control" name="nombre" id="nombre" value="${tripulante.nombre}"/>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="cargo" id="cargo" value="${tripulante.cargo}"/>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="genero" id="genero" value="${tripulante.genero}" />
						</div>
						<div class="form-group">
							<input type="number" class="form-control" name="experiencia" id="experiencia" value="${tripulante.experiencia}"/>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="origen" id="origen" value="${tripulante.origen}"/>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="raza" id="raza" value="${tripulante.raza}"/>
						</div>
						<div class="form-group">
							<input type="number" class="form-control" name="edad" id="edad" value="${tripulante.edad}" />
						</div>
						<div class="form-group">
							<input type="number" class="form-control" name="id_nave" id="id_nave" value="${tripulante.id_nave}"/>
						</div>
						<div class="form-group">
							<button type="submit" class="btn btn-secondary btnSubmit">Actualizar</button>
						</div>
						<input type="hidden" name="id_tripulante" id="id_tripulante" value="${tripulante.id_tripulante}">
					</form>
				</div>
			</div>
		</div>
