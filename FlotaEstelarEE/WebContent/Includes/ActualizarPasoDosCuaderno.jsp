		...
		<div class="form-actualizar" id="form-actualizar-nave-dos" class="container login-container">
			...
			<div class="row">
				<div class="col-md-6 login-form-1">
					...
					<form action='/FlotaEstelarEE/ServActCuaderno' method="POST">
						<div class="form-group">
							<input type="date" class="form-control" name="fecha" id="fecha" value="${cuaderno.fecha}">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="descripcion" id="descripcion" value="${cuaderno.descripcion}">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="audio" id="audio" value="${cuaderno.audio}">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="id_nave" id="id_nave" value="${cuaderno.id_nave}">
						</div>
						<div class='form-group'>
							<button type='submit' class='btn btn-secondary btnSubmit'>Actualizar</button>
						</div>
						<input type="hidden" name="id_cuaderno" id="id_cuaderno" value="${cuaderno.id_cuaderno}">
					</form>
				</div>
			</div>
		</div>
